...
# insert comments
db.add_all([
  Comment(comment_text='Thanks for the tips!', user_id=3, post_id=5),
  Comment(comment_text='ehh it was ok.', user_id=2, post_id=1),
  Comment(comment_text='So many creative uses!', user_id=3, post_id=2),
  Comment(comment_text='Insightful details. Never would have considered this', user_id=4, post_id=4),
  Comment(comment_text='Very useful!', user_id=5, post_id=4),
